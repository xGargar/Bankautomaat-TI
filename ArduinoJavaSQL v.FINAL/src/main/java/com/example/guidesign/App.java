...
public class App extends Application {
    ...
    public void start (Stage stage){
        try {
            ...
            ATM atm = new ATM(stage, mainInstance, pinCodeField, balanceField, customAmountLabel, errorLabelp3, errorLabelp5, errorLabelp12);
            atm.start();
    ...
    public PasswordField getPincodeField (Parent scene) {
        PasswordField pinCode = (PasswordField) scene.lookup("PasswordField");
        return pinCode;
    }
}
